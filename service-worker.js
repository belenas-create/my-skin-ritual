const CACHE='skin-ritual-v11-google-auth';
const CORE=['./','./index.html','./style.css','./app.js','./cloud-sync.js','./firebase-config.js','./manifest.webmanifest','./data/products.json','./assets/icons/icon-180.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/icons/icon-maskable-512.png'];
